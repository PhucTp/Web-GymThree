...
<p>Sửa sản phẩm </p>
  ...
  <tr>
    <td>Giá sản phẩm</td> 
    <td><input type="text" value="<?php echo $row['giasp'] ?>" name="giasp" id=""></td>
  </tr>
  <tr>
    <td>Số lượng</td> 
  ...
  <tr>
    <td>Tóm tắt</td> 
    <td><textarea name="tomtat" <?php echo $row['tomtat'] ?> cols="10"  rows="5"></textarea></td>
  </tr>
  <tr>
    <td>Nội dung</td> 
    <td><textarea name="noidung" <?php echo $row['noidung'] ?>  cols="30" rows="10"></textarea></td>
  </tr>  
  <tr>
